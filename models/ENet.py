...
class InitialBlock(nn.Module):
    ...
    def __init__(
        ...
        """
        Initializes the InitialBlock module with the specified parameters.
        ...
        Parameters:
            ...
            relu (bool, optional): whether to use ReLU activation, defaults to True
        """
...
class DownsamplingBottleneck(nn.Module):
    ...
    def __init__(
        ...
        """
            Initializes a DownsamplingBottleneck instance.

            Parameters:
                - in_channels (int): Number of input channels.
                - out_channels (int): Number of output channels.
                - internal_ratio (int, optional): Internal ratio of the bottleneck. Defaults to 4.
                - kernel_size (int, optional): Kernel size of the convolutions. Defaults to 3.
                - padding (int, optional): Padding of the convolutions. Defaults to 0.
                - return_indices (bool, optional): Whether to return max pool indices. Defaults to False.
                - dropout_prob (float, optional): Dropout probability. Defaults to 0.
...
class UpsamplingBottleneck(nn.Module):
    ...
    def __init__(
        ...
        """
        Initializes a UpsamplingBottleneck instance.
    ...
    def forward(self, x: torch.Tensor, max_indices: int) -> torch.Tensor:
        """
            Forward pass for the layer
